  ...
  handleState(
   ...
   undoCell(){
     if(this.lastCellIndex && this.lastCellIndex > 0){
        ...
        NotebookActions.cut(this.notebook)
        notebook.activeCellIndex = this.lastCellIndex - 1
        this.lastCellIndex = this.lastCellIndex - 1
     }
   }
}
...
export default {
  ...
  activate: function (app) {
    ...
    class ContentWidget extends Widget {
      ...
      createNode() {
        this.node.innerHTML = `<h2>Codex Chat Notebook</h2>`
        ...
        this.executeButton.onclick = async () => {
          ...
          nbExt.addCell("# " + command.trim(), completion.trim())
          this.inputBox.value = '';
        }
